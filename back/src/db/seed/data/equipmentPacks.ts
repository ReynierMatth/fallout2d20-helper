...
export const TAG_SKILL_BONUS_ITEMS: TagSkillBonusItem[] = [
  ...
  // smallGuns: Extra ammo for a weapon already owned - handled in frontend
  {
    skill: 'bigGuns',
  ...
  },
  {
    ...
    items: [
      {
        options: [
          { itemName: 'Molotov Cocktail', category: 'weapon', quantity: 2 },
          { itemName: 'Frag Grenade', category: 'weapon', quantity: 2 },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        options: [
          { itemName: 'Throwing Knife', category: 'weapon', quantity: 4, quantityCD: 2 },
          { itemName: 'Tomahawk', category: 'weapon', quantity: 2, quantityCD: 1 },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      // 2d20 extra caps
      { itemName: 'Caps', category: 'caps', quantity: 0, quantityCD: 20 },
    ],
  },
];
 ...
 */
export function getTagSkillBonusItems(skill: SkillName): EquipmentEntry[] {
