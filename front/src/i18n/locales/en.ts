export default {
  ...
  craft: {
    ...
    recipe: {
      ...
      workbench: 'Workbench',
      requiredPerks: 'Required Perks',
      craftingTest: 'Crafting Test',
      formula: 'INT + {{skill}} | Difficulty: {{complexity}} - {{rank}} = {{difficulty}}',
      automaticSuccess: 'Automatic success possible (no roll needed)',
      ...
      ingredientsLostOnFailure: 'Chemistry/Cooking: all ingredients lost on failure',
      ...
      state: {
        craftable: 'Craftable',
        known_missing_materials: 'Missing materials',
        unknown: 'Unknown',
      },
    },
    repair: {
