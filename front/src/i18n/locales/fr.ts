export default {
  ...
  characters: {
    ...
    exportError: "Échec de l'export du personnage.",
  ...
  equipment: {
    ...
    items: {
      ...
      'Lab Coat': 'Blouse',
      'Common Materials': 'Matériaux fréquents',
      'Uncommon Materials': 'Matériaux peu fréquents',
      'Rare Materials': 'Matériaux rares',
      materials: {
        common: 'Matériaux fréquents',
        uncommon: 'Matériaux peu fréquents',
        rare: 'Matériaux rares',
      },
      Caps: 'Capsules',
      // Robot arms
  ...
  craft: {
    ...
    recipe: {
      prerequisites: 'Prérequis',
      workbench: 'Établi',
      requiredPerks: 'Aptitudes requises',
      craftingTest: 'Test de fabrication',
      formula: 'INT + {{skill}} | Difficulté : {{complexity}} - {{rank}} = {{difficulty}}',
      automaticSuccess: 'Réussite automatique possible (sans jet)',
      ...
      ingredientsLostOnFailure: 'Chimie/Cuisine : tous les ingrédients perdus en cas d\'échec',
      complications: '+30min par complication (+10min cuisine). Risque de perte de matériaux.',
      markAsKnown: 'Marquer comme apprise',
      forget: 'Oublier',
      perkRank: '(rang {{rank}})',
      lockedNotice: 'Impossible de fabriquer cette recette :',
      lockedRareUnknown: 'Recette rare non apprise par ce personnage',
      lockedMissingPerks: 'Aptitudes manquantes',
      lockedMissingMaterials: 'Matériaux insuffisants',
      rarity: {
        frequente: 'Fréquente',
      ...
      materialTypes: {
        common: 'Fréquents',
        uncommon: 'Peu fréquents',
        rare: 'Rares',
      },
      state: {
        craftable: 'Réalisable',
        known_missing_materials: 'Matériaux insuffisants',
        unknown: 'Inconnue',
      },
    },
    repair: {
